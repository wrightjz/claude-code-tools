...
echo -e "  • ${BLUE}Agents${NC}: Specialized AI assistants (codebase-auditor, systems-architect)"
echo -e "  • ${BLUE}Commands${NC}: Slash commands (/spec, /plan, /sync-linear, /audit, etc.)"
echo -e "  • ${BLUE}Rules${NC}: Coding standards and best practices"
echo -e "  • ${BLUE}Skills${NC}: On-demand capabilities (TDD builds, loops, diagrams, UI)"
...
echo -e "     ${YELLOW}/spec \"your feature idea\"${NC}"
